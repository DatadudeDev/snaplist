                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          setState(() {
                                            _model.emailAddressController1
                                                ?.clear();
                                            _model.passwordController1?.clear();
                                          });
                                        },
                                        text:
                                            FFLocalizations.of(context).getText(
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'LOGIN_PAGE_Container_xei7ftsu_ON_TAP');
                                                  logFirebaseEvent(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'LOGIN_PAGE_Container_uc7s6qdc_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Container_show_snack_bar');
                                            ...
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'LOGIN_PAGE_Wrap_5xd2gpxl_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Wrap_show_snack_bar');
                                                  ScaffoldMessenger.of(context)
                                                      .showSnackBar(
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'LOGIN_PAGE_Container_d1quf8xp_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Container_show_snack_bar');
                                                  ScaffoldMessenger.of(context)
                                                      .showSnackBar(
                                            ...
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'LOGIN_PAGE_Wrap_9na4tlkx_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Wrap_show_snack_bar');
                                                  ScaffoldMessenger.of(context)
                                                      .showSnackBar(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          setState(() {
                                            _model.emailAddressController2
                                                ?.clear();
                                            _model.passwordController2?.clear();
                                          });
                                        },
                                        text:
                                            FFLocalizations.of(context).getText(
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'LOGIN_PAGE_Container_tpz7fmao_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Container_show_snack_bar');
                                                    ScaffoldMessenger.of(
                                                            context)
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'LOGIN_PAGE_Container_ile19jk4_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Container_show_snack_bar');
                                                    ScaffoldMessenger.of(
                                                            context)
