...
class DevzModel extends FlutterFlowModel<DevzWidget> {
  ...
  // Stores action output result for [Backend Call - API (Access Token)] action in devz widget.
  ...
  // Stores action output result for [Backend Call - API (Get Playlists)] action in Button widget.
  ...
  // Stores action output result for [Backend Call - API (Access Token)] action in Button widget.
